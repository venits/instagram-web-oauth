if (window.opener)
  if (window.opener.instagramClientId)
    if (window.location.href.search("instagram_auth") > -1 && -1 === window.location.href.search("error") && -1 === window.location.hash.search("access_token"))
      window.location.href = "https://api.instagram.com/oauth/authorize/?client_id=" + window.opener.instagramClientId + "&response_type=token&redirect_uri=" + window.location.href;
    else {
  ...
  if (window.parent.document.getElementById("instagramAuthFrame").src = "about:blank", window.parent.instagramClientId)
    if (window.location.href.search("instagram_auth") > -1 && -1 === window.location.href.search("error") && -1 === window.location.hash.search("access_token"))
      window.location.href = "https://api.instagram.com/oauth/authorize/?client_id=" + window.parent.instagramClientId + "&response_type=token&redirect_uri=" + window.location.href;
